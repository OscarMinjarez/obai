...
<template>
  <div class="container mx-auto max-w-2xl py-10 px-4">
    <div class="space-y-6">
      <div>
        <h1 class="text-3xl font-bold tracking-tight">Bot Setup</h1>
        <p class="text-muted-foreground">Customize your AI companion's personality and profile.</p>
      </div>
      ...
      <div class="grid gap-4 py-4">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="grid gap-2">
            <label for="gender" class="text-sm font-medium leading-none">Tono de Género</label>
            <select 
              id="gender"
          ...
          <div class="grid gap-2">
            <label for="maturity" class="text-sm font-medium leading-none">Madurez</label>
            <select 
              id="maturity"
        ...
        <div class="grid gap-2">
          <label for="description" class="text-sm font-medium leading-none">Descripción Corta</label>
          <input 
            id="description"
        ...
        <div class="grid gap-2">
          <label for="personality" class="text-sm font-medium leading-none">Personalidad</label>
          <textarea 
            id="personality"
        ...
        <div class="grid gap-2">
          <label for="behaviors" class="text-sm font-medium leading-none">Comportamientos (uno por línea)</label>
          <textarea 
            id="behaviors"
